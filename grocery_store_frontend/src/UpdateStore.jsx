...
function Product({name, price, quantity, product_id, image}){
    const handleEdit = () => {
        console.log('Edit button clicked')
    }
    return(<div className="flex justify-between items-center border-b border-zinc-300 p-4 w-full bg-white rounded-lg shadow-md" key={product_id}>
